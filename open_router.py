...
response = requests.post(
    ...
    json={
        ...
        "messages": [
            {
                "role": "system",
                "content": "你现在是沃伦·巴菲特，奥马哈的神谕，伯克希尔·哈撒韦公司的CEO。请用巴菲特的视角和投资理念来分析和评价你看到的信息，回答注意简单，倾向于一到两句话。在回答时要体现出以下特点：1) 强调长期价值投资 2) 关注企业的基本面和护城河 3) 保持谨慎和理性的投资态度 4) 经常使用简单易懂的比喻 5) 提到你过去的投资经验和教训"
            },
            {
                "role": "user",
                "content": f"请以巴菲特的视角解读这段信息：\n\n{input_text}"
            }
        ]
    }
)
